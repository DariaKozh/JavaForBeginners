...
public class Lesson6 {
    ...
    //Website У99 bottles of beerФ:	 http://www.99-bottles-of-beer.net/lyrics.html
...
//        }
        ...
        //ѕечатаем "Java for beginners" дл€ всех чисел от 1 до 5 включительно
        for (int i = 1; i < 6; i++) {
            System.out.println("Java for beginners");
        }

        //ѕечатаем числа от 1 до 5 включительно
        for (int i = 1; i < 6; i++) {
            System.out.println(i);
        }

        //ѕечатаем только нечетные числа от 1 до 10 включительно
        for (int i = 1; i < 11; i++) {
            if (i % 2 != 0) {
                System.out.println(i);
            }
        ...
        //ѕечатаем все числа от 1 до 100 включительно с шагом 10
        for (int i = 1; i < 101; i += 10) {
            System.out.println(i);
        }

        //ѕечатаем все числа в промежутке от 0 до 100 включительно, кратные 10
        for (int i = 0; i < 101; i += 10) {
            System.out.println(i);
        }

        //ѕечатаем все числа в промежутке от -100 до 100 включительно, кратные 10
        for (int i = -100; i < 101; i += 10) {
            System.out.println(i);
        }

        //ѕечатаем все числа от 5 до 1 включительно
        for (int i = 5; i > 0; i--) {
            System.out.println(i);
        }

        //—тараемс€ придумывать решени€ “ќЋ№ ќ с одним for
//        for(;;) {
//            for(;;) {
//                for(;;) {
//
...
//        }
        ...
        // ѕесенка кодом http://www.99-bottles-of-beer.net/lyrics.html
